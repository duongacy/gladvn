...
var c = a(`circle-check`, [
  ...
  u = t(),
  d = i(
    `group/alert @container/alert relative rounded-lg border text-left bg-card text-card-foreground`,
    {
      variants: {
        color: {
  ...
  f = l.forwardRef(function (
    { className: e, color: t = `info`, size: n = `md`, ...r },
    i,
  ) {
    return (0, u.jsx)(`div`, {
      ref: i,
      ...
      "data-color": t,
      role: `alert`,
      className: o(d({ color: t, size: n }), e),
      ...r,
    });
  });
f.displayName = `Alert`;
var p = l.forwardRef(function ({ className: e, ...t }, n) {
  return (0, u.jsx)(`div`, {
    ref: n,
...
var m = l.forwardRef(function ({ className: e, ...t }, n) {
  return (0, u.jsx)(`div`, {
    ref: n,
...
var h = l.forwardRef(function ({ className: e, ...t }, n) {
  return (0, u.jsx)(`div`, {
    ref: n,
...
h.displayName = `AlertAction`;
var g = l.forwardRef(function ({ className: t, render: n, ...r }, i) {
  return s({
    render: n,
    defaultTagName: `div`,
    props: e(
...
g.displayName = `AlertIcon`;
export { p as a, g as i, h as n, c as o, m as r, f as t };
