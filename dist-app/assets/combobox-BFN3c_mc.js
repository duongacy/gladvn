...
import {
  ...
  t as g,
  u as _,
} from "./combobox-DDh62TFy.js";
import { i as v, n as y, t as b } from "./input-group-CEoiDdE-.js";
import { t as x } from "./mono-select-2fT-ju4g.js";
import { a as S, i as C, n as w, o as T, r as E } from "./schemas-Dv-WZqIR.js";
var D = n(t(), 1),
  O = e(),
  k = D.forwardRef(
    (
      ...
      return (0, O.jsx)(s, {
        ...
        htmlFor: w,
        children: (0, O.jsxs)(g, {
          items: D.useMemo(() => e.map((e) => e.value), [e]),
          value: t,
          defaultValue: n,
          onValueChange: r,
          disabled: d,
...
k.displayName = `ComboboxPreset`;
var A = D.forwardRef(
  (
    { inputId: e, size: t, placeholder: n, "aria-invalid": r, disabled: i },
    a,
  ) => {
    let { setAnchor: o } = c();
    return (0, O.jsxs)(b, {
...
A.displayName = `ComboboxPresetInner`;
var j = w({ framework: E().min(1, `Vui lòng chọn một framework.`) });
function M({ size: e }) {
  let t = T({ resolver: C(j), defaultValues: { framework: `` } });
  function n(e) {
  ...
  return (0, O.jsxs)(`form`, {
    ...
    children: [
      ...
      (0, O.jsx)(o, { type: `submit`, size: e, children: `Submit` }),
    ],
  });
}
    ...
    children: [
      ...
      (0, O.jsxs)(i, {
        ...
        children: [
          (0, O.jsx)(a, {
            label: `Standard`,
            description: `Combobox cơ bản có nhãn và mô tả.`,
          ...
          (0, O.jsx)(a, {
            ...
            description: `Một combobox không tương tác.`,
            children: (0, O.jsx)(`div`, {
              className: `w-full max-w-sm`,
              children: (0, O.jsx)(k, {
                size: e,
          ...
          (0, O.jsx)(a, {
            label: `Long List`,
            description: `Thể hiện thao tác cuộn với nhiều tùy chọn.`,
            children: (0, O.jsx)(`div`, {
              className: `w-full max-w-sm`,
              children: (0, O.jsx)(k, {
                size: e,
                ...
                options: Array.from({ length: 50 }).map((e, t) => ({
                  value: `utc${t - 12}`,
                  label: `UTC ${t - 12 > 0 ? `+` : ``}${t - 12}:00`,
                })),
              }),
            }),
          }),
