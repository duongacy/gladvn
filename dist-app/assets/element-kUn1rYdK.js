...
function l(e) {
  return (
    e?.closest(
      `button,a[href],[role="button"],select,[tabindex]:not([tabindex="-1"]),${n}`,
    ) != null
  );
}
function u(e) {
  return e ? e.getAttribute(`role`) === `combobox` && c(e) : !1;
}
function d(t) {
  if (!t || e) return !0;
  try {
...
export { a, d as c, s as i, o as n, u as o, l as r, c as s, f as t };
