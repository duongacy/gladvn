...
import { t as c } from "./plus-CfSiH_cg.js";
var l = i(`folder-open`, [
    [
      `path`,
      {
...
function f({ className: e, ...t }) {
  return (0, u.jsx)(`div`, {
    ...
    className: a(`flex max-w-sm flex-col items-center gap-2`, e),
    ...t,
  });
}
var p = t(
...
function m({ className: e, variant: t, ...n }) {
  return (0, u.jsx)(`div`, {
    "data-slot": `empty-icon`,
    "data-variant": t,
    className: a(p({ variant: t, className: e })),
    ...n,
  });
}
function h({ className: e, ...t }) {
  return (0, u.jsx)(`div`, {
    ...
    className: a(`font-heading text-sm font-medium tracking-tight`, e),
    ...t,
  });
}
...
function v({ className: e, ...t }) {
  return (0, u.jsx)(`div`, {
    ...
    className: a(`flex flex-col items-center gap-2`, e),
    ...t,
  });
}
function y() {
          ...
          (0, u.jsx)(o, {
            ...
            children: (0, u.jsxs)(d, {
              ...
              children: [
                (0, u.jsxs)(f, {
                  children: [
                    (0, u.jsx)(h, { children: `No customers found` }),
                    (0, u.jsx)(g, {
                      children: `Get started by adding your first customer.`,
                    }),
                  ],
                }),
                (0, u.jsx)(_, {
            ...
            children: (0, u.jsx)(d, {
              ...
              children: (0, u.jsxs)(f, {
                children: [
                  ...
                  (0, u.jsx)(h, { children: `No projects` }),
                  (0, u.jsx)(g, {
                    children: `You don't have any active projects.`,
                  }),
                ],
              }),
            }),
