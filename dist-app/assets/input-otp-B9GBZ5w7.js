...
import { t as a } from "./minus-BfciniaV.js";
var o = n(t(), 1),
  ...
  g = (e, t) => {
    ...
    if (e != null && u)
      for (var r of u(e)) t.indexOf(r) < 0 && f.call(e, r) && (n[r] = e[r]);
    return n;
  };
function ee(e) {
...
function S({
  ...
  let [i, a] = o.useState(!1),
    ...
    f = o.useCallback(() => {
      ...
      let o = r,
        ...
        c = o.getBoundingClientRect().top + o.offsetHeight / 2,
        d = s - v,
        f = c;
      (document.querySelectorAll(x).length === 0 &&
  ...
  return (
    ...
    { hasPWMBadge: i, willPushPWMBadge: d, PWM_BADGE_SPACE_WIDTH: b }
  );
}
var C = o.createContext({}),
  w = o.forwardRef((e, t) => {
    var n = e,
      ...
      D;
    let [O, k] = o.useState(
        typeof w.defaultValue == `string` ? w.defaultValue : ``,
      ),
      A = r ?? O,
      j = _(A),
      M = o.useCallback(
      ...
      N = o.useMemo(
        () => (c ? (typeof c == `string` ? new RegExp(c) : c) : null),
        [c],
      ),
      P = o.useRef(null),
      F = o.useRef(null),
      I = o.useRef({
        ...
        isIOS:
          typeof window < `u` &&
          (D = window == null ? void 0 : window.CSS)?.supports?.call(
            D,
    ...
    (o.useImperativeHandle(t, () => P.current, []),
      o.useEffect(() => {
        let e = P.current,
          t = F.current;
        if (!e || !t) return;
        (I.current.value !== e.value && I.current.onChange(e.value),
          (L.current.prev = [
            e.selectionStart,
            e.selectionEnd,
        ...
        function n() {
          ...
          if (a.length !== 0 && t !== null && n !== null) {
            ...
            s !== -1 &&
              c !== -1 &&
              s !== c &&
              P.current.setSelectionRange(s, c, l);
          }
          let u = s === -1 ? t : s,
            d = c === -1 ? n : c,
            f = l ?? r;
        ...
        if (
          ...
          if (
            ...
            (T(
              ...
              T(e.sheet, `[data-input-otp]:autofill { ${t} }`),
              T(e.sheet, `[data-input-otp]:-webkit-autofill { ${t} }`),
              T(
                e.sheet,
    ...
    (o.useEffect(() => {
      ee(() => {
        ...
        let t = P.current?.selectionStart,
          n = P.current?.selectionEnd,
          r = P.current?.selectionDirection;
        t !== null && n !== null && (U(t), G(n), (L.current.prev = [t, n, r]));
      });
    }, [A, B]),
      o.useEffect(() => {
        j !== void 0 && A !== j && j.length < a && A.length === a && d?.(A);
      }, [a, d, j, A]));
    let K = S({
        containerRef: F,
        inputRef: P,
      ...
      J = o.useCallback(() => {
        var e;
        if (P.current) {
          let t = Math.min(P.current.value.length, a - 1),
            n = P.current.value.length;
      ...
      Y = o.useCallback(
        (e) => {
          ...
          let n = e.clipboardData.getData(`text/plain`),
            r = p ? p(n) : n;
          e.preventDefault();
          let i = P.current?.selectionStart,
            o = P.current?.selectionEnd,
            s = (
              i === o
                ? A.slice(0, i) + r + A.slice(i)
                : A.slice(0, i) + r + A.slice(o)
            ).slice(0, a);
      ...
      X = o.useMemo(
        () => ({
          position: `relative`,
          cursor: w.disabled ? `default` : `text`,
          userSelect: `none`,
      ...
      Z = o.useMemo(
        ...
        [K.PWM_BADGE_SPACE_WIDTH, K.willPushPWMBadge, s],
      ),
      Q = o.useMemo(
        () =>
          o.createElement(
            `input`,
            h(m({ autoComplete: w.autoComplete || `one-time-code` }, w), {
              "data-input-otp": !0,
              ...
              onPaste: (e) => {
                var t;
                (Y(e), (t = w.onPaste) == null || t.call(w, e));
              },
              onChange: q,
              onMouseOver: (e) => {
                var t;
                (z(!0), (t = w.onMouseOver) == null || t.call(w, e));
              },
              onMouseLeave: (e) => {
                var t;
                (z(!1), (t = w.onMouseLeave) == null || t.call(w, e));
              },
              onFocus: (e) => {
                var t;
                (J(), (t = w.onFocus) == null || t.call(w, e));
              },
              onBlur: (e) => {
                var t;
                (V(!1), (t = w.onBlur) == null || t.call(w, e));
              },
            }),
          ),
        [q, J, Y, u, Z, a, W, H, w, N?.source, A],
      ),
      $ = o.useMemo(
        () => ({
          slots: Array.from({ length: a }).map((e, t) => {
            let n =
                ...
                W !== null &&
                ((H === W && t === H) || (t >= H && t < W)),
              r = A[t] === void 0 ? null : A[t];
            return {
              char: r,
              placeholderChar: A[0] === void 0 ? (l?.[t] ?? null) : null,
              isActive: n,
              hasFakeCaret: n && r === null,
            };
          }),
          isFocused: B,
          isHovering: !w.disabled && R,
        }),
        [B, R, a, W, H, w.disabled, A],
      ),
      te = o.useMemo(
        () => (b ? b($) : o.createElement(C.Provider, { value: $ }, x)),
        [x, $, b],
      );
    return o.createElement(
      ...
      null,
      y !== null &&
        o.createElement(`noscript`, null, o.createElement(`style`, null, y)),
      o.createElement(
        `div`,
        { ref: F, "data-input-otp-container": !0, style: X, className: v },
        te,
        o.createElement(
          `div`,
...
function k({ className: e, containerClassName: t, size: n = `md`, ...r }) {
  return (0, D.jsx)(w, {
    "data-slot": `input-otp`,
    containerClassName: i(O({ size: n }), t),
    spellCheck: !1,
    className: i(`disabled:cursor-not-allowed disabled:opacity-100`, e),
    ...r,
  });
}
...
function j({ index: e, className: t, ...n }) {
  let {
    char: r,
    hasFakeCaret: a,
    isActive: s,
  } = o.useContext(C)?.slots[e] ?? {};
  return (0, D.jsxs)(`div`, {
...
function M({ ...e }) {
  return (0, D.jsx)(`div`, {
    ...
    className: `flex items-center text-muted-foreground [&>svg:not([class*='size-'])]:size-4 group-[.otp-sm]/otp:[&>svg:not([class*='size-'])]:size-3.5`,
    role: `separator`,
    ...e,
    children: (0, D.jsx)(a, {}),
  });
}
export { j as i, A as n, M as r, k as t };
