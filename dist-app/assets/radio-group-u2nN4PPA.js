...
import { t as l } from "./field-preset-D4aZ2rJM.js";
import { n as u, t as d } from "./radio-group-HdCfCKXo.js";
import { t as f } from "./mono-select-2fT-ju4g.js";
import { a as p, i as m, n as h, o as g, r as _ } from "./schemas-Dv-WZqIR.js";
var v = n(t(), 1),
  y = e(),
  b = v.forwardRef(
    (
          ...
          children: e.map((e) =>
            (0, y.jsxs)(
              `div`,
              {
                ...
                children: [
                  (0, y.jsxs)(`div`, {
                    className: a(`flex items-center leading-snug`, b),
                    children: [
                      `​`,
                      (0, y.jsx)(u, {
                        value: e.value,
                  ...
                  (0, y.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      e.description &&
                        (0, y.jsx)(`p`, {
                          className: a(`text-muted-foreground`, b),
...
b.displayName = `RadioGroupPreset`;
var x = h({ notify: _().min(1, `Vui lòng chọn phương thức thông báo.`) });
function S({ size: e }) {
  let t = g({ resolver: m(x), defaultValues: { notify: `` } });
  function n(e) {
  ...
  return (0, y.jsxs)(`form`, {
    ...
    children: [
      ...
      (0, y.jsx)(s, { type: `submit`, size: e, children: `Submit` }),
    ],
  });
}
    ...
    children: [
      ...
      (0, y.jsxs)(i, {
        ...
        children: [
          (0, y.jsx)(o, {
            label: `Standard`,
            description: `Nhóm radio cơ bản có nhãn và mô tả.`,
          ...
          (0, y.jsx)(o, {
            ...
            description: `Một nhóm radio không tương tác.`,
            children: (0, y.jsx)(`div`, {
              className: `w-full max-w-sm flex flex-col gap-6`,
              children: (0, y.jsx)(b, {
                size: e,
          ...
          (0, y.jsx)(o, {
            ...
            description: `Các tùy chọn có mô tả dài để kiểm tra việc gói và căn chỉnh.`,
            children: (0, y.jsx)(`div`, {
              className: `w-full max-w-sm`,
              children: (0, y.jsx)(b, {
                size: e,
                ...
                options: [
                  ...
                  { value: `dark`, label: `Dark Theme` },
                  {
                    ...
                    description: `This is a custom rich description.`,
                  },
                ],
