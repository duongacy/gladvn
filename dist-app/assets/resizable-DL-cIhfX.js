  ...
  return n === 0
    ...
    : t.map((e) => {
        ...
        r.collapsedSize !== void 0 &&
          (i = m(
            (p({ groupSize: n, panelElement: t, styleProp: r.collapsedSize }) /
              n) *
              100,
          ));
        let a;
        r.defaultSize !== void 0 &&
          (a = m(
            (p({ groupSize: n, panelElement: t, styleProp: r.defaultSize }) /
              n) *
              100,
          ));
        let o = 0;
        r.minSize !== void 0 &&
          (o = m(
            (p({ groupSize: n, panelElement: t, styleProp: r.minSize }) / n) *
              100,
          ));
        let s = 100;
        return (
          r.maxSize !== void 0 &&
            (s = m(
              (p({ groupSize: n, panelElement: t, styleProp: r.maxSize }) / n) *
                100,
            )),
          {
...
function _(e, t = `Assertion error`) {
  if (!e) throw Error(t);
}
function v(e, t) {
  return Array.from(t).sort(e === `horizontal` ? y : b);
}
function y(e, t) {
...
function C({ orientation: e, rects: t, targetRect: n }) {
    ...
    p = [];
  {
    ...
    for (let t of a)
      t.hasAttribute(`data-panel`) &&
        (e++,
        t.hasAttribute(`data-disabled`) || (d++, l === -1 && (l = e), (u = e)));
  }
  if (d > 1) {
    let t = -1;
    for (let d of a)
...
var D = class {
  ...
  O = { cursorFlags: 0, state: `inactive` },
  k = new D();
function A() {
  return O;
}
function j(e) {
  return k.addListener(`change`, e);
}
function ee(e) {
  let t = O,
    n = { ...O };
  ((n.cursorFlags = e), (O = n), k.emit(`change`, { prev: t, next: n }));
}
function M(e) {
  let t = O;
  ((O = e), k.emit(`change`, { prev: t, next: e }));
}
var te = (e) => e,
  ne = () => {},
  re = 1,
...
function ue({ cursorFlags: e, groups: t, state: n }) {
  let r = 0,
    i = 0;
  switch (n) {
    case `active`:
    case `hover`:
      t.forEach((e) => {
        if (!e.mutableState.disableCursor)
...
function fe(e) {
  ...
  let { prevStyle: t, styleSheet: n } = de.get(e) ?? {};
  n === void 0 &&
    ((n = new e.defaultView.CSSStyleSheet()),
    e.adoptedStyleSheets &&
      (Object.isExtensible(e.adoptedStyleSheets)
        ? e.adoptedStyleSheets.push(n)
  ...
  de.set(e, { prevStyle: t, styleSheet: n });
}
var P = new Map(),
  pe = new D();
function me(e) {
  ((P = new Map(P)), P.delete(e));
}
function he(e, t) {
  for (let [t] of P) if (t.id === e) return t;
}
function F(e, t) {
  for (let [t, n] of P) if (t.id === e) return n;
...
function L(e, t) {
  return pe.addListener(`groupChange`, (n) => {
    n.group.id === e && t(n);
  });
}
function R(e, t, n) {
...
function ge(e) {
  ...
  switch (t.state) {
    case `active`:
      (M({ cursorFlags: 0, state: `inactive` }),
        t.hitRegions.length > 0 &&
          (fe(e),
          (n = !0),
          t.hitRegions.forEach((e) => {
            let t = F(e.group.id, !0);
            R(e.group, t, { isUserInteraction: !0 });
          })));
  }
  return n;
}
function _e(e) {
  e.defaultPrevented || ge(e.currentTarget);
}
function ve(e, t, n) {
  let r,
    i = { x: 1 / 0, y: 1 / 0 };
...
function Se(e) {
  let t = getComputedStyle(De(e) ?? e).display;
...
function Ce(e) {
  ...
  return !!(
    t.position === `fixed` ||
    (t.zIndex !== `auto` && (t.position !== `static` || Se(e))) ||
    +t.opacity < 1 ||
...
function we(e) {
  ...
  for (; t--;) {
    let n = e[t];
    if ((_(n, `Missing node`), Ce(n))) return n;
  }
  return null;
}
function Te(e) {
...
function ke({ groupElement: e, hitRegion: t, pointerEventTarget: n }) {
  if (!x(n) || n.contains(e) || e.contains(n)) return !0;
  if (be(n, e) > 0) {
    let r = n;
    for (; r;) {
      if (r.contains(e)) return !0;
      if (Oe(r.getBoundingClientRect(), t)) return !1;
      r = r.parentElement;
    }
  }
  return !0;
...
function z(e, t) {
  ...
  return (
    t.forEach((t, r) => {
      ...
      let i = E(r),
        a = ve(r.orientation, i, { x: e.clientX, y: e.clientY });
      a &&
        a.distance.x <= 0 &&
        a.distance.y <= 0 &&
        ke({
...
function U({
  ...
  let o = a === `imperative-api`,
    ...
    l = [...s],
    [u, d] = r;
  (_(u != null, `Invalid first pivot index`),
    _(d != null, `Invalid second pivot index`));
  let f = 0;
  switch (a) {
    case `keyboard`:
      {
        let t = e < 0 ? d : u,
          r = n[t];
        _(r, `Panel constraints not found for index ${t}`);
        let { collapsedSize: i = 0, collapsible: a, minSize: o = 0 } = r;
        if (a) {
          let n = s[t];
          if (
            (_(n != null, `Previous layout not found for panel index ${t}`),
            B(n, i))
          ) {
            let t = o - n;
      ...
      }
      {
        let t = e < 0 ? u : d,
          r = n[t];
        _(r, `No panel constraints found for index ${t}`);
        let { collapsedSize: i = 0, collapsible: a, minSize: o = 0 } = r;
        if (a) {
          let n = s[t];
          if (
  ...
  }
  {
    ...
    for (;;) {
      let e = s[r];
      _(e != null, `Previous layout not found for panel index ${r}`);
      let a =
        H({
  ...
  }
  {
    ...
    for (; t >= 0 && t < n.length;) {
      let r = Math.abs(e) - Math.abs(f),
        i = s[t];
      _(i != null, `Previous layout not found for panel index ${t}`);
      let a = i - r,
        c = H({
          overrideDisabledPanels: o,
  ...
  if (Ae(c, l)) return i;
  {
    let t = e < 0 ? d : u,
      r = s[t];
    _(r != null, `Previous layout not found for panel index ${t}`);
    let i = r + f,
      a = H({
        overrideDisabledPanels: o,
        panelConstraints: n[t],
    ...
    if (((l[t] = a), !B(a, i))) {
      ...
      for (; r >= 0 && r < n.length;) {
        let i = l[r];
        _(i != null, `Previous layout not found for panel index ${r}`);
        let a = i + t,
          s = H({
            overrideDisabledPanels: o,
            panelConstraints: n[r],
        ...
        if ((B(i, s) || ((t -= s - i), (l[r] = s)), B(t, 0))) break;
        e > 0 ? r-- : r++;
      }
    }
  }
...
function G({ layout: e, panelConstraints: t }) {
  ...
  if (!B(i, 100) && r.length > 0)
    for (let e = 0; e < t.length; e++) {
      let t = r[e];
      (_(t != null, `No layout data found for index ${e}`),
        (r[e] = (100 / i) * t));
    }
  let a = 0;
  for (let e = 0; e < t.length; e++) {
    let i = n[e];
    _(i != null, `No layout data found for index ${e}`);
    let o = r[e];
    _(o != null, `No layout data found for index ${e}`);
    let s = H({
  ...
  if (!B(a, 0))
    for (let e = 0; e < t.length; e++) {
      let n = r[e];
      _(n != null, `No layout data found for index ${e}`);
      let i = n + a,
        o = H({
          overrideDisabledPanels: !0,
          panelConstraints: t[e],
      ...
      if (n !== o && ((a -= o - n), (r[e] = o), B(a, 0))) break;
    }
  let o = Object.keys(e);
  return r.reduce((e, t, n) => ((e[o[n]] = t), e), {});
}
function je({ groupId: e, panelId: t }) {
  let n = () => {
      let t = I();
      for (let [
        n,
    ...
    o = ({
      ...
      if (
        ...
        e < o &&
        (c ||
          n.slice(0, s).every((e, t) => {
            let n = i[t];
            return n?.collapsible && B(n.collapsedSize, r[n.panelId]);
          }))
      ) {
  ...
  return {
    ...
    resize: (e) => {
      let { group: t } = n(),
        { element: r } = i(),
        a = h({ group: t }),
        o = m((p({ groupSize: a, panelElement: r, styleProp: e }) / a) * 100);
      s(o);
    },
  };
}
      ...
      if (t.separator && !t.separator.disableDoubleClick) {
        ...
        if (n) {
          let r = n.panelConstraints.defaultSize,
            i = je({ groupId: t.group.id, panelId: n.id });
  ...
  return {
    ...
    setLayout(e) {
      let {
        ...
        c = G({ layout: e, panelConstraints: r });
      return n
        ? o
        : (W(o, c) ||
            R(i, {
...
function q(e, t) {
  ...
  _(i, `Matching separator not found`);
  let a = r.separatorToPanels.get(i);
  _(a, `Matching panels not found`);
  let o = a.map((e) => n.panels.indexOf(e)),
    s = Ne({ groupId: n.id }).getLayout(),
    c = G({
      layout: U({
        delta: t,
        initialLayout: s,
  ...
  if (!n.disabled)
    switch (e.key) {
      ...
      case `Enter`: {
        ...
        _(o, `Matching separator not found`);
        let s = a.get(o);
        _(s, `Matching panels not found`);
        let c = s[0],
          l = r.find((e) => e.panelId === c.id);
        if ((_(l, `Panel metadata not found`), l.collapsible)) {
          let e = i[c.id];
          q(
            t,
            (l.collapsedSize === e
              ? (n.mutableState.expandedPanelSizes[c.id] ?? l.minSize)
              : l.collapsedSize) - e,
          );
        }
        break;
...
function Fe(e) {
  ...
  (n.forEach((e) => {
    e.separator &&
      (i ||
        ((i = !0),
        e.separator.element.focus({ focusVisible: !1, preventScroll: !0 })));
    let n = t.get(e.group);
...
function Ie({
  ...
  n.forEach((e) => {
    let { group: n, groupSize: o } = e,
      { orientation: c, panels: l } = n,
      { disableCursor: u } = n.mutableState,
      d = 0;
    d = a
      ? c === `horizontal`
        ? ((t.clientX - a.x) / o) * 100
  ...
  let c = 0;
  (t.movementX === 0 ? (c |= o & se) : (c |= s & se),
    t.movementY === 0 ? (c |= o & ce) : (c |= s & ce),
    ee(c),
    fe(e));
}
function Le(e) {
...
function Re(e) {
  ...
  switch (t.state) {
    ...
    default: {
      let r = z(e, n);
      (r.length === 0
        ? t.state !== `inactive` && M({ cursorFlags: 0, state: `inactive` })
        : M({ cursorFlags: 0, hitRegions: r, state: `hover` }),
        fe(e.currentTarget));
      break;
    }
  }
...
function Be(e) {
  e.defaultPrevented ||
    ...
    (ge(e.currentTarget) && e.preventDefault());
}
function Ve(e) {
  let t = 0,
    n = 0,
...
function We({ group: e, nextGroupSize: t, prevGroupSize: n, prevLayout: r }) {
  ...
  if (
    ...
    for (let e of c) u[e] = m(((r[e] ?? 0) / a) * l);
  else {
    let e = m(l / c.length);
...
function Ke(e) {
  let t = !0;
  _(e.element.ownerDocument.defaultView, `Cannot register an unmounted Group`);
      ...
      for (let r of n) {
        ...
        if (i === e.element) {
          if (t) {
            ...
            if (!n) return;
            let r = g(e),
              i = n.defaultLayoutDeferred ? Ve(r) : n.layout,
              a = G({
                layout: We({
                  group: e,
                  nextGroupSize: t,
            ...
            if (
              !n.defaultLayoutDeferred &&
              W(n.layout, a) &&
              Ue(n.derivedPanelConstraints, r) &&
              n.groupSize === t
            )
              return;
            R(e, {
  ...
  let o = h({ group: e }),
    ...
    l = e.mutableState.defaultLayout;
  l && (Ge(e.panels, l) || (l = void 0));
  let u = G({
      layout: e.mutableState.layouts[c] ?? l ?? Ve(s),
      panelConstraints: s,
    }),
  ...
  return (
    ...
    e.separators.forEach((e) => {
      (_(
        ...
        i.add(e.id),
        e.element.addEventListener(`keydown`, Pe));
    }),
    J.get(d) === 1 &&
      (d.addEventListener(`contextmenu`, _e, !0),
      d.addEventListener(`dblclick`, Me, !0),
      d.addEventListener(`pointerdown`, Fe, !0),
      d.addEventListener(`pointerleave`, Le),
      d.addEventListener(`pointermove`, Re),
      d.addEventListener(`pointerout`, ze),
      d.addEventListener(`pointerup`, Be, !0)),
    function () {
      ((t = !1),
        J.set(d, Math.max(0, (J.get(d) ?? 0) - 1)),
        me(e),
        e.separators.forEach((e) => {
          e.element.removeEventListener(`keydown`, Pe);
        }),
        J.get(d) ||
          (d.removeEventListener(`contextmenu`, _e, !0),
          d.removeEventListener(`dblclick`, Me, !0),
          d.removeEventListener(`pointerdown`, Fe, !0),
          d.removeEventListener(`pointerleave`, Le),
          d.removeEventListener(`pointermove`, Re),
          d.removeEventListener(`pointerout`, ze),
          d.removeEventListener(`pointerup`, Be, !0)),
        a.disconnect());
    }
  );
}
function qe() {
  ...
  return [e, (0, s.useCallback)(() => t({}), [])];
}
function Je(e) {
  let t = (0, s.useId)();
  return `${e ?? t}`;
}
var Y = typeof window < `u` ? s.useLayoutEffect : s.useEffect;
function X(e) {
  let t = (0, s.useRef)(e);
  return (
    Y(() => {
    ...
    (0, s.useCallback)((...e) => t.current?.(...e), [t])
  );
}
function Ye(...e) {
  return X((t) => {
...
var Ze = (0, s.createContext)(null);
function Qe(e, t) {
  let n = (0, s.useRef)({ getLayout: () => ({}), setLayout: te });
  ((0, s.useImperativeHandle)(t, () => n.current, []),
    Y(() => {
      Object.assign(n.current, Ne({ groupId: e }));
    }));
}
function $e({
  children: e,
  ...
  resizeTargetMinimumSize: p = { coarse: 20, fine: 10 },
  style: m,
  ...h
}) {
  let _ = (0, s.useRef)({ onLayoutChange: {}, onLayoutChanged: {} }),
    y = X((e) => {
      W(_.current.onLayoutChange, e) ||
        ((_.current.onLayoutChange = e), u?.(e));
    }),
    b = X((e, t) => {
      W(_.current.onLayoutChanged, e) ||
        ((_.current.onLayoutChanged = e), d?.(e, { isUserInteraction: t }));
    }),
    x = Je(l),
    S = (0, s.useRef)(null),
    [C, w] = qe(),
  ...
  let D = X((e, t) => {
    ...
    O = Xe({ defaultLayout: n, disableCursor: r }),
    k = (0, s.useMemo)(
      () => ({
        get disableCursor() {
        ...
        registerSeparator: (e) => {
          let t = T.current;
          return (
            (t.separators = v(f, [...t.separators, e])),
            w(),
            () => {
        ...
        updatePanelProps: (e, { disabled: t }) => {
          ...
          let r = he(x),
            i = F(x);
          r && i && R(r, { ...i, derivedPanelConstraints: g(r) });
        },
  ...
  return (
    Y(() => {
      ...
      if (
        ...
        Object.keys(O.defaultLayout).length === t.panels.length
      ) {
        n = {};
      ...
      let l = L(x, (e) => {
        ...
        ((r.mutableState.layouts[a] = i),
          n.forEach((t) => {
            if (t.collapsible) {
              let { layout: n } = e.prev ?? {};
              if (n) {
                let e = B(t.collapsedSize, i[t.panelId]),
                  a = B(t.collapsedSize, n[t.panelId]);
                e &&
                  !a &&
                  (r.mutableState.expandedPanelSizes[t.panelId] = n[t.panelId]);
              }
            }
          }));
        let o = A().state !== `active`;
        (y(i), o && b(i, e.isUserInteraction));
      });
      return () => {
        ((j.current = null), a(), l());
      };
    ...
    (0, s.useEffect)(() => {
      let e = j.current;
      e &&
        ((e.mutableState.defaultLayout = n),
        (e.mutableState.disableCursor = !!r));
    }),
    (0, o.jsx)(Ze.Provider, {
      value: k,
...
function et(e, t) {
  ...
  ((0, s.useImperativeHandle)(t, () => r.current, []),
    Y(() => {
      Object.assign(r.current, je({ groupId: n, panelId: e }));
    }));
}
function tt({
  children: e,
  ...
  let k = () => {
    ...
    A = (0, s.useSyncExternalStore)((e) => L(C, e), k, k),
    j;
  return (
    (j = A
      ? JSON.parse(A)
      : i === void 0
        ? { flexGrow: 1 }
        : { flexGrow: void 0, flexShrink: void 0, flexBasis: i }),
    (0, o.jsx)(`div`, {
      ...g,
...
function rt({ layout: e, panelConstraints: t, panelId: n, panelIndex: r }) {
  let i,
    a,
    o = e[n],
...
function it({
  ...
  let u = Je(a),
    d = Xe({ disabled: n, disableDoubleClick: r }),
    [f, p] = (0, s.useState)({}),
    [m, h] = (0, s.useState)(`inactive`),
    [g, _] = (0, s.useState)(!1),
    v = (0, s.useRef)(null),
    y = Ye(v, i),
    {
    ...
    T = S === `horizontal` ? `vertical` : `horizontal`;
  (Y(() => {
    let e = v.current;
    if (e !== null) {
      let t = {
          disabled: d.disabled,
          disableDoubleClick: d.disableDoubleClick,
          element: e,
          id: u,
        },
        n = C(t),
        r = j((e) => {
          h(
            e.next.state !== `inactive` &&
              e.next.hitRegions.some((e) => e.separator === t)
              ? e.next.state
              : `inactive`,
          );
        }),
    ...
    (0, s.useEffect)(() => {
      w(u, { disabled: n, disableDoubleClick: r });
    }, [n, r, u, w]));
  let E;
  n && !b && (E = `not-allowed`);
  let D;
...
function Q({ ...e }) {
  return (0, o.jsx)(tt, { "data-slot": `resizable-panel`, ...e });
}
function $({ withHandle: e, className: t, ...n }) {
  return (0, o.jsx)(it, {
        ...
        children: (0, o.jsxs)(at, {
          ...
          children: [
            (0, o.jsx)(Q, {
              ...
              minSize: 15,
              children: (0, o.jsx)(`div`, {
                className: `flex h-[250px] items-center justify-center p-6`,
                children: (0, o.jsx)(`span`, {
                  className: `font-semibold text-sm`,
                  children: `Nav`,
                }),
