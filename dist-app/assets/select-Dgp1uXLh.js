...
import { a as c, i as l, n as u, o as d, r as f } from "./schemas-Dv-WZqIR.js";
var p = n(t(), 1),
  m = e(),
  h = u({ language: f().min(1, `Vui lòng chọn một ngôn ngữ.`) });
function g({ size: e }) {
  let t = d({ resolver: l(h), defaultValues: { language: `` } });
  function n(e) {
  ...
  return (0, m.jsxs)(`form`, {
    ...
    children: [
      ...
      (0, m.jsx)(o, { type: `submit`, size: e, children: `Submit` }),
    ],
  });
}
