...
import { n as c, r as l } from "./index-Dk0REsC9.js";
import { i as u, o as d, r as f, t as p } from "./field-DA6j2oEX.js";
import { t as m } from "./mono-select-2fT-ju4g.js";
import { a as h, i as g, n as _, o as v, t as y } from "./schemas-Dv-WZqIR.js";
var b = n(t(), 1),
  x = e(),
  S = b.forwardRef(
    (
      ...
      return (0, x.jsxs)(p, {
        ...
        children: [
          (0, x.jsxs)(`div`, {
            ...
            children: [
              (0, x.jsxs)(`div`, {
                ...
                children: [
                  e && (0, x.jsx)(d, { htmlFor: _, children: e }),
                  t && (0, x.jsx)(f, { children: t }),
                ],
              }),
              (0, x.jsx)(c, {
                ref: h,
          ...
          r && n && (0, x.jsx)(u, { children: n }),
        ],
      });
    },
  );
S.displayName = `SwitchPreset`;
var C = _({ marketing: y().default(!1).optional() });
function w({ size: e }) {
  let t = v({ resolver: g(C), defaultValues: { marketing: !1 } });
  function n(e) {
  ...
  return (0, x.jsxs)(`form`, {
    ...
    children: [
      ...
      (0, x.jsx)(s, { type: `submit`, size: e, children: `Submit` }),
    ],
  });
}
      ...
      (0, x.jsxs)(i, {
        ...
        children: [
          ...
          (0, x.jsx)(o, {
            ...
            description: `Một công tắc không tương tác.`,
            children: (0, x.jsxs)(`div`, {
              className: `w-full max-w-sm flex flex-col gap-6`,
              children: [
                (0, x.jsx)(S, {
          ...
          (0, x.jsx)(o, {
            ...
            description: `Nhãn tùy chỉnh và mô tả dài.`,
            children: (0, x.jsx)(`div`, {
              className: `w-full max-w-sm`,
              children: (0, x.jsx)(S, {
                size: e,
