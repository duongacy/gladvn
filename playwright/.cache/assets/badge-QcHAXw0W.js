...
import { m as mergeProps } from './useRenderElement-CBh4CqIk.js';
import { u as useRender } from './index-CsFA-J_C.js';
...
const Badge = reactExports.forwardRef(
  ({ className, variant = "solid", color = "primary", render, ...props }, ref) => {
    return useRender({
      defaultTagName: "span",
      props: mergeProps(
        {
...
//# sourceMappingURL=badge-QcHAXw0W.js.map
