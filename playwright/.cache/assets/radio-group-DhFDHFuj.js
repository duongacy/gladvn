import { e as useMergedRefs, E as EMPTY_OBJECT, k as EMPTY_ARRAY$1, u as useRenderElement, f as formatErrorMessage, N as NOOP, h as useStableCallback, d as useIsoLayoutEffect, g as getWindow, j as jsxRuntimeExports, a as cn, c as cva } from './utils-Boq2ewKh.js';
import { r as reactExports } from './index-DN3kw-fw.js';
import { v as visuallyHiddenInput, a as visuallyHidden, u as useValueChanged } from './useValueChanged-BCnrh8Dv.js';
import { f as fieldValidityMapping, a as useFieldRootContext, b as useLabelableContext, c as useBaseUiId, g as createChangeEventDetails, n as none, u as useFormContext, d as useControlled, e as useRegisterFieldControl } from './createBaseUIEventDetails-CHsRwCdV.js';
import { t as transitionStatusMapping, u as useFieldItemContext, a as useTransitionStatus, b as useOpenChangeComplete } from './useTransitionStatus-APX8IVyJ.js';
import './index-6mpbiNdg.js';
import { a as useCompositeRootContext, u as useButton, C as CompositeRootContext } from './useButton-CAPP_3d9.js';
import { u as useCompositeListItem, s as scrollIntoViewIfNeeded, C as COMPOSITE_KEYS, A as ARROW_KEYS, a as ARROW_LEFT, b as ARROW_RIGHT, c as ARROW_DOWN, d as ARROW_UP, i as isNativeInput, V as VERTICAL_KEYS_WITH_EXTRA_KEYS, e as VERTICAL_KEYS, H as HORIZONTAL_KEYS_WITH_EXTRA_KEYS, f as HORIZONTAL_KEYS, g as HOME, E as END, M as MODIFIER_KEYS$1, h as useDirection, j as CompositeList, S as SHIFT } from './DirectionContext-BAzFkpam.js';
...
import { i as isListIndexDisabled, f as findNonDisabledListIndex, b as isIndexOutOfListBounds, g as getTarget, c as getMinListIndex, d as getMaxListIndex, e as contains } from './utils-D8p5eZrR.js';
...
//# sourceMappingURL=radio-group-DhFDHFuj.js.map
