...
import { CheckboxPreset } from "../macro/checkbox-preset";
import { InputPreset } from "../macro/input-preset";
import { Button } from "../micro/button";
import { Field, FieldContent, FieldLabel } from "../micro/field";
import { InputGroup, InputGroupAddon, InputGroupButton, InputGroupInput } from "../micro/input-group";
    ...
    <div className="flex min-h-screen w-full">
      <div className="hidden lg:flex w-1/2 flex-col justify-between bg-primary p-12 text-primary-foreground relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-4 text-sm font-medium">
          ...
          <p>Trusted by over 10k+ developers</p>
        </div>
      </div>
