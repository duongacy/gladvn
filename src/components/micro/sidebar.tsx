...
import { Tooltip, TooltipContent, TooltipTrigger } from "@/components/micro/tooltip";
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          {
            "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4)))]": variant === "floating" || variant === "inset",
