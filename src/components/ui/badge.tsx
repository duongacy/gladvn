...
const badgeVariants = cva(
  "group/badge inline-flex h-6 w-fit shrink-0 items-center justify-center gap-1.5 overflow-hidden rounded-4xl border border-transparent px-2.5 py-0.5 text-xs font-medium whitespace-nowrap transition-colors focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:ring-offset-1 focus-visible:ring-offset-background has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 [&>svg]:pointer-events-none [&>svg]:size-3.5",
  {
    ...
    compoundVariants: [
      ...
      { variant: "solid", color: "tertiary", className: "bg-tertiary text-tertiary-foreground" },
      ...
      { variant: "outline", color: "destructive", className: "border-destructive text-destructive" },
      ...
      { variant: "outline", color: "tertiary", className: "border-tertiary text-tertiary" },
      { variant: "outline", color: "muted", className: "border-muted text-muted-foreground" },
      ...
      { variant: "soft", color: "secondary", className: "bg-secondary/15 text-secondary" },
      { variant: "soft", color: "destructive", className: "bg-destructive/15 text-destructive" },
      { variant: "soft", color: "warning", className: "bg-warning/15 text-warning" },
      { variant: "soft", color: "success", className: "bg-success/15 text-success" },
      { variant: "soft", color: "info", className: "bg-info/15 text-info" },
      { variant: "soft", color: "tertiary", className: "bg-tertiary/15 text-tertiary" },
      { variant: "soft", color: "muted", className: "bg-muted/50 text-muted-foreground" },
      { variant: "soft", color: "accent", className: "bg-accent/50 text-accent-foreground" },
    ],
    defaultVariants: {
      variant: "solid",
      color: "primary",
