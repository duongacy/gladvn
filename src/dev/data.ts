...
export const COMPONENTS = [
  { id: "accordion", label: "Accordion", hasMicro: true, hasMacro: true },
  { id: "alert", label: "Alert", hasMicro: true, hasMacro: true },
  { id: "alert-dialog", label: "Alert Dialog", hasMicro: true, hasMacro: true },
  { id: "aspect-ratio", label: "Aspect Ratio", hasMicro: true, hasMacro: false },
  { id: "avatar", label: "Avatar", hasMicro: true, hasMacro: true },
  { id: "badge", label: "Badge", hasMicro: true, hasMacro: false },
  ...
  { id: "collapsible", label: "Collapsible", hasMicro: true, hasMacro: false },
  ...
  { id: "dialog", label: "Dialog", hasMicro: true, hasMacro: false },
  ...
  { id: "input", label: "Input", hasMicro: true, hasMacro: true },
  ...
  { id: "textarea", label: "Textarea", hasMicro: true, hasMacro: true },
