...
export const COMPONENTS = [
  ...
  { id: "calendar", label: "Calendar", hasMicro: true, hasMacro: false, status: "stable" },
  ...
  { id: "command", label: "Command", hasMicro: true, hasMacro: false, status: "stable" },
  { id: "context-menu", label: "Context Menu", hasMicro: true, hasMacro: false, status: "stable" },
  ...
  { id: "label", label: "Label", hasMicro: true, hasMacro: false, status: "stable" },
  { id: "menubar", label: "Menubar", hasMicro: true, hasMacro: false },
  { id: "navigation-menu", label: "Navigation Menu", hasMicro: true, hasMacro: false, status: "stable" },
  { id: "pagination", label: "Pagination", hasMicro: true, hasMacro: true },
  { id: "popover", label: "Popover", hasMicro: true, hasMacro: false, status: "stable" },
  { id: "progress", label: "Progress", hasMicro: true, hasMacro: true, status: "stable" },
  ...
  { id: "switch", label: "Switch", hasMicro: true, hasMacro: true, status: "stable" },
  { id: "table", label: "Table", hasMicro: true, hasMacro: false, status: "stable" },
  { id: "tabs", label: "Tabs", hasMicro: true, hasMacro: true, status: "stable" },
  ...
  { id: "tooltip", label: "Tooltip", hasMicro: true, hasMacro: false, status: "stable" },
];
