  ...
  return (
    <div className="space-y-10 mt-6">
      <ShowcaseDocs>
        ...
        <DocsP>
          <DocsCode>AvatarPreset</DocsCode> tự động tính toán chữ cái viết tắt (fallback) dựa trên thuộc tính <DocsCode>alt</DocsCode>. Nó cũng hỗ trợ truyền trực tiếp <DocsCode>status</DocsCode> thay vì phải tự đặt thẻ <DocsCode>AvatarBadge</DocsCode> với class màu sắc như Micro.
        </DocsP>
      </ShowcaseDocs>

      <ExampleGrid columns={2}>
        <ExampleSection label="Tiêu chuẩn (Standard)" description="Avatar tự động fallback dựa vào tên truyền vào alt."
...
`}>
        ...
        <ExampleSection label="Trạng thái (Status)" description="Hỗ trợ sẵn các trạng thái: online, offline, away."
          codeString={`<div className="flex items-center gap-4">
...
`}>
      ...
      <ExampleSection label="Nhóm Avatar (Avatar Group)" description="Kết hợp Preset với AvatarGroup để tiết kiệm code." fullWidth
  ...
  return (
    <div className="space-y-10 mt-6">
      <ShowcaseDocs>
        ...
        <DocsP>
          Dùng <DocsCode>Avatar</DocsCode> khi bạn muốn có một <DocsCode>AvatarFallback</DocsCode> phức tạp (ví dụ: hiển thị một Icon User) thay vì chỉ là chữ cái viết tắt mặc định, hoặc muốn tùy chỉnh vị trí/màu sắc của <DocsCode>AvatarBadge</DocsCode> hoàn toàn tự do.
        </DocsP>
      </ShowcaseDocs>
...
export default function AvatarShowcase() {
  ...
  return (
    <Showcase
      ...
      tabs={[
        { label: "Micro (Primitive)", content: <AvatarMicroShowcase globalSize={globalSize} /> },
        { label: "Macro (Preset)", content: <AvatarMacroShowcase globalSize={globalSize} /> },
      ]}
    />
  );
}
