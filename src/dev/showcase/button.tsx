...
function ButtonMicroShowcase({ globalSize }: { globalSize: Size }) {
  ...
  return (
    <div className="space-y-10">
      <ShowcaseExample title="Variants" description="Tất cả các kiểu hiển thị hiện có." code={`<Button variant="solid">Solid</Button>
  <Button variant="outline">Outline</Button>
  <Button variant="soft">Soft</Button>
  <Button variant="ghost">Ghost</Button>
  <Button variant="link">Link</Button>`} preview={
                  <>
      ...
      <ShowcaseExample title="Colors" description="Các màu semantic đi kèm variant solid." code={`<Button color="primary">Primary</Button>
  ...
  <Button color="accent">Accent</Button>`} preview={
                  <>
      ...
      <ExampleGrid>
        <ShowcaseExample title="With Icon" description="Button kèm icon ở đầu hoặc cuối." code={`<Button variant="outline">
  ...
  <Button>
    ...
    Download
        ...
        <ShowcaseExample title="Icon Only" description="Button vuông chỉ chứa icon." code={`<Button variant="outline" iconOnly={true}>
  ...
  <Button variant="soft" iconOnly={true}>
    <ButtonIcon render={<DownloadIcon />} />
      ...
      <ShowcaseExample title="Disabled" description="Button không thể tương tác, hiển thị mờ." code={`<Button disabled>Solid Disabled</Button>
  ...
  <Button variant="link" disabled>
    Link Disabled
      ...
      <ExampleGrid>
        <ShowcaseExample title="Loading State" description="Button kèm Spinner khi đang xử lý async." code={`<Button
    color="primary"
    className="w-full"
    disabled={isSending}
    onClick={handleSend}
  ...
  <Button variant="outline" className="w-full">
    Save Draft
        ...
        <ShowcaseExample title="Destructive" description="Xác nhận hành động nguy hiểm (xoá dữ liệu, huỷ tài khoản...)." code={`<Button
    color="destructive"
