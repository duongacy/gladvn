...
export default function ButtonShowcase() {
  ...
  return (
    <div className="space-y-10">
      ...
      {/* ── Colors ── */}
      <ExampleSection label="Colors" description="Semantic color tokens paired with the solid variant.">
        <div className="flex flex-wrap items-center gap-3">
      ...
      <ExampleGrid columns={2}>
        <ExampleSection label="With Icon" description="Buttons with leading or trailing icons.">
          <div className="flex flex-wrap items-center gap-3">
        ...
        <ExampleSection label="Icon Only" description="Square buttons with only an icon.">
          <div className="flex flex-wrap items-center gap-3">
      ...
      {/* ── Disabled ── */}
      <ExampleSection label="Disabled" description="Non-interactive button states.">
        <div className="flex flex-wrap items-center gap-3">
      ...
      {/* ── Real-world examples ── */}
      <ExampleGrid columns={2}>
        <ExampleSection label="Loading State" description="Button with spinner during async action." fullWidth>
        ...
        <ExampleSection label="Destructive" description="Confirming a dangerous action." fullWidth>
