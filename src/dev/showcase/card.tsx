    ...
    <div className="space-y-10">
      <ExampleGrid>
        <ShowcaseExample
          ...
          description={t(
            "Card cài sẵn với đầy đủ tiêu đề, nội dung và chân trang.",
            "Pre-built card with title, content, and footer.",
          )}
          code={`<CardPreset
    ...
    <div className="text-sm text-muted-foreground bg-muted/30 p-4 rounded-lg border border-dashed border-border/50">
      Settings form content goes here.
        ...
        <ShowcaseExample
          ...
          description={t(
            "Bỏ qua prop footer để ẩn hoàn toàn phần chân trang.",
            "Omit the footer prop to hide the footer section completely.",
          )}
          code={`<CardPreset
  ...
  >
    <div className="text-sm text-muted-foreground bg-muted/30 p-4 rounded-lg border border-dashed border-border/50">
      Switches and toggles go here.
        ...
        <ShowcaseExample
          title={t("Tiêu đề tùy chỉnh", "Custom Title Node")}
          description={t(
            "Tiêu đề hỗ trợ nhận ReactNode thay vì string.",
            "Title supports ReactNode instead of just a string.",
          )}
          code={`<CardPreset
    title={
  ...
  return (
    <div className="space-y-10">
      <ShowcaseExample
        ...
        description={t(
          "Lắp ráp thủ công từ CardHeader, CardTitle, CardContent, CardFooter.",
          "Manually assembled from CardHeader, CardTitle, CardContent, CardFooter.",
        )}
    ...
    <CardFooter className="flex justify-between">
      ...
      <ExampleGrid>
        <ShowcaseExample
          ...
          description={t(
            "Dùng Card như một container bọc ngoài đơn giản.",
            "Use Card as a simple outer container.",
          )}
    ...
    <CardContent>
      <p className="text-sm text-muted-foreground pt-4 md:pt-6">
          ...
          preview={
            <>
              <Card size={globalSize} className="w-full">
                <CardContent>
                  <p className="text-sm text-muted-foreground pt-4 md:pt-6">
                    "This is a simple content-only card without a header or
                    footer. Useful for wrapping any content in a card
                    container."
                  </p>
                </CardContent>
              </Card>
        ...
        <ShowcaseExample
          ...
          description={t(
            "Tích hợp menu góc phải mà Preset khó thực hiện.",
            "Integrates a right-side menu that Preset can't easily do.",
          )}
          code={`<Card className="w-full">
    <CardHeader>
