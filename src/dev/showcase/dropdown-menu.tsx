...
function DropdownMenuMicroShowcase({ globalSize }: { globalSize: Size }) {
  ...
  return (
    <div className="space-y-10">
      <ExampleGrid>
        <ShowcaseExample title="Standard Dropdown" description="Menu cơ bản với các phím tắt và action nguy hiểm." code={`<DropdownMenu>
    <DropdownMenuTrigger
    ...
    />
      ...
      <DropdownMenuContent className="w-56">
        ...
        <ShowcaseExample title="With Disabled Items" description="Một số mục không tương tác." code={`<DropdownMenu>
    <DropdownMenuTrigger
    ...
    />
      ...
      <DropdownMenuContent className="w-56">
        ...
        <ShowcaseExample title="Advanced Dropdown" description="Menu có các hộp kiểm, mục radio và menu con." code={`<DropdownMenu>
    <DropdownMenuTrigger
    ...
    />
      ...
      <DropdownMenuContent className="w-56">
        ...
        <ShowcaseExample title="Inset Items" description="Dùng prop inset trên label và items khi menu không có icon — giữ alignment đồng đều." code={`<DropdownMenu>
    <DropdownMenuTrigger
      render={
...
export default function DropdownMenuShowcase() {
  ...
  return (
    <Showcase
      ...
      micro={{ content: <DropdownMenuMicroShowcase globalSize={globalSize} /> }}
    />
  );
}
