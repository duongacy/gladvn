  ...
  return (
    <div className="space-y-10 mt-6">
      <ShowcaseDocs>
        ...
        <DocsP>
          <DocsCode>InputOTPPreset</DocsCode> tự động sinh ra các nhóm số (`InputOTPGroup`) và dấu phân cách (`InputOTPSeparator`) dựa vào prop <DocsCode>groups</DocsCode> (ví dụ: `groups={[3, 3]}`). Dùng Preset này cho 99% các trường hợp form nhập mã xác thực (OTP) vì nó đã tích hợp sẵn Label và Error Message.
        </DocsP>
      </ShowcaseDocs>
...
/>`}
        >
          <div className="w-full flex flex-col gap-6">
            <InputOTPPreset
              groups={[2, 2, 2]}
              separator={<span className="text-muted-foreground/50 text-sm font-semibold">/</span>}
              size={globalSize}
  ...
  return (
    <div className="space-y-10 mt-6">
      <ShowcaseDocs>
        ...
        <DocsP>
          Dùng <DocsCode>InputOTP</DocsCode> và <DocsCode>InputOTPGroup</DocsCode> thủ công khi bạn cần một giao diện nhập mã đặc thù không theo chuẩn (ví dụ: các ô số nằm rải rác trong một thiết kế đồ hoạ) hoặc khi chèn trực tiếp vào một luồng không có Label đi kèm.
        </DocsP>
      </ShowcaseDocs>
...
export default function InputOTPShowcase() {
  ...
  return (
    <Showcase
      ...
      tabs={[
        { label: "Micro (Primitive)", content: <InputOTPMicroShowcase globalSize={globalSize} /> },
        { label: "Macro (Preset)", content: <InputOTPMacroShowcase globalSize={globalSize} /> },
      ]}
    />
  );
}
