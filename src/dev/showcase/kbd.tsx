...
function KbdMicroShowcase() {
  ...
  <Tooltip>
    <TooltipTrigger render={<Button variant="outline" iconOnly><SaveIcon /></Button>} />
    <TooltipContent>
  ...
  <KbdGroup className="ml-auto">
    <Kbd>⌘</Kbd><Kbd>S</Kbd>
      ...
      <ExampleSection
        ...
        codeString={`<p className="text-sm text-muted-foreground">
  Nhấn <Kbd>Enter</Kbd> để gửi, hoặc <KbdGroup><Kbd>⇧</Kbd><Kbd>Enter</Kbd></KbdGroup> để xuống dòng.
</p>`}
      >
