...
import { RadioGroup, RadioGroupItem, MonoSelect, Field, FieldLabel, Label } from "../../index";
...
export default function RadioGroupShowcase() {
  ...
  return (
    <div className="space-y-10">
      <SectionHeader title="Radio Group" description="A set of checkable buttons—known as radio buttons—where no more than one of the buttons can be checked at a time.">
        <MonoSelect
          value={globalSize}
      ...
      <ExampleGrid columns={2}>
        <ExampleSection label="Standard" description="Vertical list of radio options.">
          <div className="space-y-2">
            <Label size={globalSize} className="mb-2 block text-muted-foreground">Density Preference</Label>
        ...
        <ExampleSection label="Disabled" description="Non-interactive radio states.">
          <div className="space-y-2">
            <RadioGroup defaultValue="opt1" className="space-y-1">
              <Field orientation="horizontal" size={globalSize}>
                <RadioGroupItem disabled size={globalSize} value="opt1" id="r-d1" />
                <FieldLabel htmlFor="r-d1">Selected (Disabled)</FieldLabel>
              </Field>
              <Field orientation="horizontal" size={globalSize}>
                <RadioGroupItem disabled size={globalSize} value="opt2" id="r-d2" />
