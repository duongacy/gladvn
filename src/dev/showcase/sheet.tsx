...
export default function SheetShowcase() {
  return (
    <div className="space-y-10">
      <SectionHeader title="Sheet" description="Extends the Dialog component to display content that complements the main content of the screen." />

      <ExampleSection label="Directions" description="Sheet can slide from any edge.">
