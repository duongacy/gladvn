...
import { Switch, MonoSelect, Field, FieldLabel, Label } from "../../index";
...
export default function SwitchShowcase() {
  ...
  return (
    <div className="space-y-10">
      <SectionHeader title="Switch" description="A control that allows the user to toggle between checked and not checked.">
        <MonoSelect
          value={globalSize}
      ...
      <ExampleGrid columns={2}>
        <ExampleSection label="Standard" description="Used for immediate toggle actions.">
        ...
        <ExampleSection label="Disabled" description="Non-interactive switch states.">
          <div className="w-full max-w-sm space-y-4">
