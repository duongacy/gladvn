  ...
  return (
    <div className="space-y-10 mt-6">
      <ShowcaseDocs>
        ...
        <DocsP>
          <DocsCode>TextareaPreset</DocsCode> là một component hoàn chỉnh, tích hợp sẵn Label, Description và Error Message. Sử dụng nó cho đa số các trường hợp để giữ code ngắn gọn và đảm bảo tính nhất quán (Accessibility).
        </DocsP>
      </ShowcaseDocs>

      <ExampleGrid columns={2}>
        <ExampleSection label="Tiêu chuẩn" description="Trường văn bản nhiều dòng với nhãn và mô tả.">
          <TextareaPreset
        ...
        <ExampleSection label="Lỗi xác thực (Validation Error)" description="Hiển thị thông báo lỗi khi đầu vào không hợp lệ.">
          <TextareaPreset
            label="Khiếu nại"
...
return (
  ...
  />
        ...
        <ExampleSection label="Khóa / Bất hoạt (Disabled)" description="Trường văn bản không thể tương tác.">
          <TextareaPreset
      ...
      <ExampleSection label="Thực tế sử dụng (Real-world Form)" description="Trình bày bố cục trong ngữ cảnh biểu mẫu rộng hơn." fullWidth
  ...
  return (
    <div className="space-y-10 mt-6">
      <ShowcaseDocs>
        ...
        <DocsP>
          <DocsCode>Textarea</DocsCode> chỉ là một ô nhập liệu độc lập. Dùng nó khi bạn tự quản lý <DocsCode>Field</DocsCode> thủ công hoặc khi chèn Textarea vào bên trong một <DocsCode>InputGroup</DocsCode>.
        </DocsP>
      </ShowcaseDocs>

      <ExampleGrid columns={2}>
        <ExampleSection label="Cơ bản (Primitive)" description="Khung nhập văn bản nhiều dòng không có nhãn.">
          <Textarea
            size={globalSize}
            rows={4}
        ...
        <ExampleSection label="Auto Resize (CSS content)" description="Giãn chiều cao tự động nhờ class field-sizing-content (nếu trình duyệt hỗ trợ).">
          <Textarea
            size={globalSize}
      ...
      <ExampleGrid columns={2}>
        <ExampleSection label="InputGroup + Textarea" description="Textarea bên trong InputGroup với Addon. Sử dụng InputGroupTextarea.">
        ...
        <ExampleSection label="Trạng thái Lỗi thủ công" description="Tự gắn aria-invalid vào Textarea và dùng FieldError.">
          <Field size={globalSize} className="w-full">
...
export default function TextareaShowcase() {
  ...
  return (
    <Showcase
      ...
      tabs={[
        { label: "Micro (Primitive)", content: <TextareaMicroShowcase globalSize={globalSize} /> },
        { label: "Macro (Preset)", content: <TextareaMacroShowcase globalSize={globalSize} /> },
      ]}
    />
  );
}
